...
app.use(cors());
app.use(express.json({ limit: '100mb' })); // Límite aumentado
app.use(express.urlencoded({ limit: '100mb', extended: true })); // Límite aumentado
...
app.get('/api/contactos/:codigo', async (req, res) => {
    try {
        // AÑADIDO: Seleccionamos ultima_conexion para el estado Online
